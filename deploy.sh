...
ssh ubuntu@ec2-54-91-172-100.compute-1.amazonaws.com 'rm /usr/local/scheduler/scheduler-api.jar'
ssh ubuntu@ec2-54-91-172-100.compute-1.amazonaws.com 'rm /usr/local/scheduler/scheduler-service.jar'
