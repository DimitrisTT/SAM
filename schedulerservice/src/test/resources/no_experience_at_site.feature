Feature: No Experience At Site

  Background:
    Given No Experience At Site being active is 'true'
    And its No Experience At Site score impact is '-50'
    And it No Experience At Site has is Hard Impact set to 'false'

  Scenario: testing rule firing for those all with site experience
    ...
    And the following hard skills
      | id | description     |
      | 33 | firearm license |
    And the following employees with site experience
    ...
    And the following employee constraint multipliers
      | id   | name          | multiplier |
      | 1111 | HAS_SITE_EXPERIENCE | 1          |
      | 1112 | HAS_SITE_EXPERIENCE | 1          |
      | 1113 | HAS_SITE_EXPERIENCE | 1          |
      | 1114 | HAS_SITE_EXPERIENCE | 1          |
      | 1115 | HAS_SITE_EXPERIENCE | 1          |
      | 1116 | HAS_SITE_EXPERIENCE | 1          |
      | 1117 | HAS_SITE_EXPERIENCE | 1          |
      | 1118 | HAS_SITE_EXPERIENCE | 1          |
      | 1119 | HAS_SITE_EXPERIENCE | 1          |
      | 1120 | HAS_SITE_EXPERIENCE | 1          |
  ...
  Scenario: testing rule firing for half of those with site experience
    Given the following site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
    And the following soft skills
      | id | description |
  ...
  Scenario: testing rule firing for those with no site experience
    Given the following site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
    And the following soft skills
      | id | description |
