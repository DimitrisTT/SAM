Feature: Scale Fact Level
  ...
  Scenario: Level rule firing for those all with the scale Fact set to a rating of 1 and a square impact
  ...
  Scenario: Level rule firing for those all with the scale Fact set to a rating of 1 and a linear impact
    Given a site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
  ...
  Scenario: Level rule firing for those all with the scale Fact set to a rating of 3 and a square impact
    Given a site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
    And the ScaleFact impact has square 'true' and impact of '50'
    And the following scales
  ...
  Scenario: Level rule firing for those all with the scale Fact set to a rating of 3 and a linear impact
    Given a site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
    And the ScaleFact impact has square 'false' and impact of '50'
    And the following scales
  ...
  Scenario: Level rule firing for those all with the scale Fact set to a rating of 5 and a square impact
    Given a site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
    And the ScaleFact impact has square 'true' and impact of '50'
    And the following scales
  ...
  Scenario: Level rule firing for those all with the scale Fact set to a rating of 5 and a linear impact
    Given a site with id '12' name 'bank' longitude '14.14' and latitude '15.15'
    And with payType 'EMPLOYEE_RATE'
    And the ScaleFact impact has square 'false' and impact of '50'
    And the following scales
